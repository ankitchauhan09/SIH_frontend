...
const JobCard = ({ jobData, onClick }) => {
    ...
    return (
        <div
            onClick={handleClick}
            className="bg-neutral-800 rounded-lg p-5 mb-4 text-white hover:bg-neutral-700/50 transition-all cursor-pointer border border-neutral-700"
        >
            <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                    <h2 className="text-xl font-semibold text-orange-500">{jobData.title}</h2>
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-2 mb-4">
                ...
                <div className="flex items-center">
                    <BriefcaseBusiness className="w-4 h-4 text-orange-500 mr-2" />
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    ...
                    className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-1.5 rounded-full hover:from-orange-600 hover:to-orange-700 transition-all text-sm"
                >
                    Apply Now
                </button>
            </div>
